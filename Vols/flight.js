...
//console.log(`il y a ${i} résultats à votre recherche`);console.log();
...
//la variable vols pour chaques vol, fonction fléchée
//vols.forEach((vol) => {
//si la la compagnie aérienne et la destinations sont strictement égale
//"===" strictement égale//"&&" les deux conditions sont remplies
...
//si la la compagnie aérienne et la destinations sont strictement égale
//"===" strictement égale//"&&" les deux conditions sont remplies
//if(vol.compagnie_aerienne === 'Air france' && vol.prix <'700'){
//console.log(vol);
//};
//});
